<script type="text/javascript">	   
    function validation() {       
        ...
        else
        {
            ...
            if (con == true)
            {               
                $.post("add_driver1", {driver_name: driver_name, driver_number: driver_number}, function (res)
                {//alert(res);
                    if (res == 1) {
						alert('Successful');
				...
				<div class="panel-body">
					<form class="form-horizontal">
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" name="driver_number" id="driver_number"  class="form-control" placeholder="Driver mobile number"/>
						</div>
					  </div>
					  <div class="form-group">
