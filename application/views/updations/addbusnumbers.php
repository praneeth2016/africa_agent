<script type="text/javascript">
    ...
    function validation() {
        ...
        else
        {
            ...
            if (con == true)
            {               
                $.post("add_bus_numbers1", {bus_number: bus_number}, function (res)
                {//alert(res);
                    if (res == 1) {
						alert('Successful');
		...
		<main class="container-fluid">		
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title">ADD Bus Numbers<span style="float: right"> <i class="fa fa-times-circle" aria-hidden="true"></i>&nbsp;</span></h3>
				</div>
				<div class="panel-body">
					<table width="100%" border="0" cellspacing="1" cellpadding="1" style="margin-top:15px">
						...
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td><input  type="button" class="btn btn-primary" name="btn" id='btn' value="ADD" onclick="validation()" /></td>
							<td>&nbsp;</td>
						</tr>
					</table>
				</div>
